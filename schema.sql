...
\restrict k2yK2nAyTTy63O5dYlkYrOviRCXC8qK5kB3nG1qdbMQQ4OG4ysrrSUAsQhQlSe1
...
--
-- Name: regenerate_case_payload(uuid); Type: FUNCTION; Schema: public; Owner: ryanhaines
--
...
ALTER FUNCTION public.regenerate_case_payload(case_uuid uuid) OWNER TO ryanhaines;

--
-- Name: FUNCTION regenerate_case_payload(case_uuid uuid); Type: COMMENT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: update_updated_at_column(); Type: FUNCTION; Schema: public; Owner: ryanhaines
--
...
ALTER FUNCTION public.update_updated_at_column() OWNER TO ryanhaines;
...
--
-- Name: cases; Type: TABLE; Schema: public; Owner: ryanhaines
--
...
ALTER TABLE public.cases OWNER TO ryanhaines;

--
-- Name: TABLE cases; Type: COMMENT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: COLUMN cases.raw_payload; Type: COMMENT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: COLUMN cases.latest_payload; Type: COMMENT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: discovery_details; Type: TABLE; Schema: public; Owner: ryanhaines
--
...
ALTER TABLE public.discovery_details OWNER TO ryanhaines;

--
-- Name: TABLE discovery_details; Type: COMMENT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: issue_categories; Type: TABLE; Schema: public; Owner: ryanhaines
--
...
ALTER TABLE public.issue_categories OWNER TO ryanhaines;

--
-- Name: TABLE issue_categories; Type: COMMENT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: issue_options; Type: TABLE; Schema: public; Owner: ryanhaines
--
...
ALTER TABLE public.issue_options OWNER TO ryanhaines;

--
-- Name: TABLE issue_options; Type: COMMENT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: parties; Type: TABLE; Schema: public; Owner: ryanhaines
--
...
ALTER TABLE public.parties OWNER TO ryanhaines;

--
-- Name: TABLE parties; Type: COMMENT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: COLUMN parties.party_number; Type: COMMENT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: COLUMN parties.is_head_of_household; Type: COMMENT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: party_issue_selections; Type: TABLE; Schema: public; Owner: ryanhaines
--
...
ALTER TABLE public.party_issue_selections OWNER TO ryanhaines;

--
-- Name: TABLE party_issue_selections; Type: COMMENT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: v_cases_complete; Type: VIEW; Schema: public; Owner: ryanhaines
--
...
ALTER TABLE public.v_cases_complete OWNER TO ryanhaines;

--
-- Name: v_plaintiff_issues; Type: VIEW; Schema: public; Owner: ryanhaines
--
...
ALTER TABLE public.v_plaintiff_issues OWNER TO ryanhaines;

--
-- Name: cases cases_pkey; Type: CONSTRAINT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: discovery_details discovery_details_pkey; Type: CONSTRAINT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: discovery_details discovery_party_unique; Type: CONSTRAINT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: issue_categories issue_categories_category_code_key; Type: CONSTRAINT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: issue_categories issue_categories_pkey; Type: CONSTRAINT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: issue_options issue_options_category_code_unique; Type: CONSTRAINT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: issue_options issue_options_pkey; Type: CONSTRAINT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: parties parties_case_party_number_unique; Type: CONSTRAINT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: parties parties_pkey; Type: CONSTRAINT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: party_issue_selections party_issue_selections_pkey; Type: CONSTRAINT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: party_issue_selections party_issue_unique; Type: CONSTRAINT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: idx_cases_active; Type: INDEX; Schema: public; Owner: ryanhaines
--
...
--
-- Name: idx_cases_city_state; Type: INDEX; Schema: public; Owner: ryanhaines
--
...
--
-- Name: idx_cases_created_at; Type: INDEX; Schema: public; Owner: ryanhaines
--
...
--
-- Name: idx_cases_property_address; Type: INDEX; Schema: public; Owner: ryanhaines
--
...
--
-- Name: idx_discovery_party; Type: INDEX; Schema: public; Owner: ryanhaines
--
...
--
-- Name: idx_one_hoh_per_unit; Type: INDEX; Schema: public; Owner: ryanhaines
--
...
--
-- Name: INDEX idx_one_hoh_per_unit; Type: COMMENT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: idx_parties_case_id; Type: INDEX; Schema: public; Owner: ryanhaines
--
...
--
-- Name: idx_parties_full_name; Type: INDEX; Schema: public; Owner: ryanhaines
--
...
--
-- Name: idx_parties_hoh; Type: INDEX; Schema: public; Owner: ryanhaines
--
...
--
-- Name: idx_parties_type; Type: INDEX; Schema: public; Owner: ryanhaines
--
...
--
-- Name: idx_party_issues_option; Type: INDEX; Schema: public; Owner: ryanhaines
--
...
--
-- Name: idx_party_issues_party; Type: INDEX; Schema: public; Owner: ryanhaines
--
...
--
-- Name: v_cases_complete _RETURN; Type: RULE; Schema: public; Owner: ryanhaines
--
...
--
-- Name: cases update_cases_updated_at; Type: TRIGGER; Schema: public; Owner: ryanhaines
--
...
--
-- Name: discovery_details update_discovery_updated_at; Type: TRIGGER; Schema: public; Owner: ryanhaines
--
...
--
-- Name: parties update_parties_updated_at; Type: TRIGGER; Schema: public; Owner: ryanhaines
--
...
--
-- Name: discovery_details discovery_details_party_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: issue_options issue_options_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: parties parties_case_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: party_issue_selections party_issue_selections_issue_option_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ryanhaines
--
...
--
-- Name: party_issue_selections party_issue_selections_party_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ryanhaines
--
...
\unrestrict k2yK2nAyTTy63O5dYlkYrOviRCXC8qK5kB3nG1qdbMQQ4OG4ysrrSUAsQhQlSe1
